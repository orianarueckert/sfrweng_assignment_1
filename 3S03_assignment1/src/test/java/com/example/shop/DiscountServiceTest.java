...
class DiscountServiceTest {
    ...
    /*
    @Test
    void applyDiscount_blankCode_returnsSubtotalUnchanged() {
    ...
    */
    ...
    /*
    @Test
    void applyDiscount_unknownCode_returnsSubtotalUnchanged() {
        assertEquals(100.0, discountService.applyDiscount(100.0, "SOMETHING"), 1e-9);
    }
    */
